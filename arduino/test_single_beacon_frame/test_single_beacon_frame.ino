/*
  ...
  SkyLift V0.3 (Solitude Edition) is a continuation of the first prototype, SkyLift V0.1, a collaboration
...
uint8_t channel = 1; // Transmit on this channel
char* ssid = "Network1"; // Name of WLAN network
